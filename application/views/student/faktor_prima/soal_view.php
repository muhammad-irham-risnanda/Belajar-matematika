            ...
            <div class="col-md-8">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <form id="quizForm" action="<?php echo site_url('pages/submit_soal_faktor_prima'); ?>" method="post">
                        <?php foreach ($faktor_primas as $index => $faktor_prima): ?>
                            <div class="question">
                                <p><?php echo ($index + 1) . ". " . $faktor_prima->question; ?></p> <!-- Menambahkan nomor pertanyaan -->
                                <label><input type="radio" name="answer_<?php echo $faktor_prima->id; ?>" value="A" onchange="updateStatus(<?php echo $index; ?>)"> <?php echo $faktor_prima->option_a; ?></label><br>
                                <label><input type="radio" name="answer_<?php echo $faktor_prima->id; ?>" value="B" onchange="updateStatus(<?php echo $index; ?>)"> <?php echo $faktor_prima->option_b; ?></label><br>
                                <label><input type="radio" name="answer_<?php echo $faktor_prima->id; ?>" value="C" onchange="updateStatus(<?php echo $index; ?>)"> <?php echo $faktor_prima->option_c; ?></label><br>
                                <label><input type="radio" name="answer_<?php echo $faktor_prima->id; ?>" value="D" onchange="updateStatus(<?php echo $index; ?>)"> <?php echo $faktor_prima->option_d; ?></label><br>
                            </div>
                        <?php endforeach; ?>
