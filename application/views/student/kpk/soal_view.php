                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <?php foreach ($kpks as $index => $kpk): ?>
                            <div class="question">
                                <p><?php echo ($index + 1) . ". " . $kpk->question; ?></p> <!-- Menambahkan nomor pertanyaan -->
                                <label><input type="radio" name="answer_<?php echo $kpk->id; ?>" value="A" onchange="updateStatus(<?php echo $index; ?>)"> <?php echo $kpk->option_a; ?></label><br>
                                <label><input type="radio" name="answer_<?php echo $kpk->id; ?>" value="B" onchange="updateStatus(<?php echo $index; ?>)"> <?php echo $kpk->option_b; ?></label><br>
                                <label><input type="radio" name="answer_<?php echo $kpk->id; ?>" value="C" onchange="updateStatus(<?php echo $index; ?>)"> <?php echo $kpk->option_c; ?></label><br>
                                <label><input type="radio" name="answer_<?php echo $kpk->id; ?>" value="D" onchange="updateStatus(<?php echo $index; ?>)"> <?php echo $kpk->option_d; ?></label><br>
                            </div>
                        <?php endforeach; ?>
