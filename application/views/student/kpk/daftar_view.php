    ...
    <div class="row">
            ...
            <div class="box">
                ...
                <form action="<?php echo site_url('pages/authenticate'); ?>" method="post">
                    ...
                    <div class="form-group d-flex align-items-center mb-3 password-field">
                        ...
                        <input type="password" id="password" name="password" class="form-control" required style="flex: 1;">
                    </div>
        ...
        <div class="col-md-4">
            <div class="box">
                ...
                <p>Silakan masukkan username, kelas, dan password Anda untuk masuk ke latihan. Akun yang digunakan adalah akun yang telah kalian buat</p>
